...
vi.mock('lucide-vue-next', () => ({
	...
	CalendarPlus: { name: 'CalendarPlus', template: '<svg></svg>' },
	CalendarOff: { name: 'CalendarOff', template: '<svg></svg>' },
	FileDown: { name: 'FileDown', template: '<svg></svg>' },
	Link2: { name: 'Link2', template: '<svg></svg>' },
	...
	StickyNote: { name: 'StickyNote', template: '<svg></svg>' },
	ArrowRightLeft: { name: 'ArrowRightLeft', template: '<svg></svg>' },
	MailOpen: { name: 'MailOpen', template: '<svg></svg>' },
	CheckSquare: { name: 'CheckSquare', template: '<svg></svg>' },
	CalendarCheck: { name: 'CalendarCheck', template: '<svg></svg>' },
	...
	Percent: { name: 'Percent', template: '<svg></svg>' },
}));
