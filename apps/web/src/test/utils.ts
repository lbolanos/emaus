...
export function createMockExcelFile(overrides: Partial<File> = {}): File {
  ...
  const blob = new Blob([defaultContent], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
 ...
 */
export function mockComponentMethod(wrapper: VueWrapper, methodName: string, implementation: (...args: any[]) => any = jest.fn()) {
