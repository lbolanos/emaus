...
const tableColumns = ['firstName', 'lastName', 'paymentAmount', 'paymentDate', 'isScholarship'];
const formShowColumns = ['firstName', 'lastName', 'paymentAmount', 'paymentDate', 'isScholarship'];
