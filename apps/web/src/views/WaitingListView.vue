...
const tableColumns = ['firstName', 'lastName', 'type', 'isCancelled'];
const formShowColumns = ['firstName', 'lastName', 'type', 'isCancelled'];
const nonEditableColumns = ['firstName', 'lastName', 'type'];
