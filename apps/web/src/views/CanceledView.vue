...
const serverTableColumns = ['id_on_retreat','firstName', 'lastName', 'email', 'cellPhone', 'parish', 'paymentRemaining','type'];
const serverFormShowColumns = ['id_on_retreat','firstName', 'lastName', 'cellPhone', 'parish', 'paymentRemaining', 'email'];
...
<template>
  <ParticipantList
    ...
    :default-filters="{ isCancelled: true }"
  />
</template>
