...
const tableColumns = ['firstName', 'lastName', 'hasDietaryRestrictions', 'dietaryRestrictionsDetails'];
const formShowColumns = ['firstName', 'lastName', 'hasDietaryRestrictions', 'dietaryRestrictionsDetails'];
