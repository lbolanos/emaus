...
import { Search, Copy, ChevronLeft, ChevronRight, ChevronUp, ChevronDown } from 'lucide-vue-next';
      ...
      <CardContent>
        ...
        <div v-else class="space-y-4">
          ...
          <div v-if="filteredAndSortedTemplates.length === 0 && !loading" class="text-center py-12 text-muted-foreground">
            ...
            <div class="text-sm">
              {{ searchQuery || selectedTypeFilter !== 'all' ? 'Intenta ajustar tus filtros de búsqueda' : 'Crea tu primera plantilla haciendo clic en el botón de arriba' }}
            </div>
          </div>
        </div>
      </div>
