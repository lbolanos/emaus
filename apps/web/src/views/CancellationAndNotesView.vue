...
const tableColumns = ['id_on_retreat','firstName', 'lastName', 'isCancelled', 'type', 'notes'];
const formShowColumns = ['id_on_retreat','firstName', 'lastName', 'isCancelled', 'type', 'notes'];
