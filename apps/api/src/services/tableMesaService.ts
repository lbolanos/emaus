				...
				new TableRow({
					children: [
						new TableCell({
							children: [
								new Paragraph({
									children: [new TextRun({ text: "NOMBRE COMPLETO", bold: true, size: 12, color: "FFFFFF" })],
									alignment: AlignmentType.CENTER,
								})
							],
						...
						new TableCell({
							children: [
								new Paragraph({
									children: [new TextRun({ text: "TELÉFONOS", bold: true, size: 12, color: "FFFFFF" })],
									alignment: AlignmentType.CENTER,
								})
							],
							width: { size: 35, type: WidthType.PERCENTAGE },
				...
				new TableRow({
					children: [
						...
						new TableCell({
							children: [
								new Paragraph({
									children: [new TextRun({ text: "NOMBRE", bold: true, size: 10, color: "FFFFFF" })],
									alignment: AlignmentType.CENTER,
								})
							],
						...
						new TableCell({
							children: [
								new Paragraph({
									children: [new TextRun({ text: "TELÉFONOS", bold: true, size: 10, color: "FFFFFF" })],
									alignment: AlignmentType.CENTER,
								})
							],
						...
						new TableCell({
							children: [
								new Paragraph({
									children: [new TextRun({ text: "MEDICAMENTOS", bold: true, size: 10, color: "FFFFFF" })],
									alignment: AlignmentType.CENTER,
								})
							],
							width: { size: 18, type: WidthType.PERCENTAGE },
						...
						new TableCell({
							children: [
								new Paragraph({
									children: [new TextRun({ text: "ALIMENTACIÓN", bold: true, size: 10, color: "FFFFFF" })],
									alignment: AlignmentType.CENTER,
								})
							],
							width: { size: 18, type: WidthType.PERCENTAGE },
						...
						new TableCell({
							children: [
								new Paragraph({
									children: [new TextRun({ text: "CONTACTO EMERGENCIA", bold: true, size: 10, color: "FFFFFF" })],
									alignment: AlignmentType.CENTER,
								})
							],
							width: { size: 20, type: WidthType.PERCENTAGE },
