		...
		this.inheritanceRules = [
			{
				...
				conditions: [{ resource: 'payments', operation: 'manage', required: true }],
			},
			{
				parentRole: 'admin',
				childRole: 'logística',
				inheritPermissions: true,
				inheritDelegation: true,
				conditions: [{ resource: 'inventory', operation: 'manage', required: true }],
			},
			{
				parentRole: 'admin',
				childRole: 'servidor',
		...
		this.delegationRules = [
			{
				fromRole: 'admin',
				toRole: 'tesorero',
				permissions: ['payments:read', 'payments:create', 'payments:update'],
