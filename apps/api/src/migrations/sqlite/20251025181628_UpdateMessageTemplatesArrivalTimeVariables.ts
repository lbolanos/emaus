...
export class UpdateMessageTemplatesArrivalTimeVariables20251025181628 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        try {
            ...
            console.log(`🎉 Successfully updated ${totalUpdates} message templates to use new arrival time variables`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        try {
            ...
            console.log(`📊 Found ${retreatTemplateUpdates.length} retreat-specific templates to rollback`);
            ...
            const totalUpdates = retreatTemplateUpdates.length + globalTemplateUpdates.length;
            console.log(`✅ Successfully rolled back ${totalUpdates} message templates to use {participant.hora_llegada}`);
