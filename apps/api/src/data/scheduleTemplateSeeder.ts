...
const POLANCO_ITEMS: SeedRow[] = [
	...
	{ defaultDay: 1, defaultOrder: 5, defaultStartTime: '10:30', defaultDurationMinutes: 90, name: 'Llegada de servidores a Casa de Retiro', type: 'logistica', description: 'Arribo del equipo. Acomodo de equipaje, asignación de cuartos del equipo y check-in inicial.', responsabilityName: R.logistica },
	{ defaultDay: 1, defaultOrder: 10, defaultStartTime: '12:00', defaultDurationMinutes: 40, name: 'Misa de servidores', type: 'misa', requiresResponsable: true, locationHint: 'Casa de Retiro', description: 'Eucaristía privada del equipo para encomendar el retiro al Señor antes de la llegada de los caminantes. A las 12:00 en la casa: si se hiciera en la parroquia habría que adelantarla (~9:00) para que el equipo llegue a preparar.', responsabilityName: R.sacerdotes },
	{ defaultDay: 1, defaultOrder: 15, defaultStartTime: '13:00', defaultDurationMinutes: 60, name: 'Comida del equipo', type: 'comida', blocksSantisimoAttendance: true, locationHint: 'Comedor', description: 'Comida en comunidad antes de empezar la preparación operativa de la casa.', responsabilityName: R.comedor },
	...
	{ defaultDay: 1, defaultOrder: 163, defaultStartTime: '22:07', defaultDurationMinutes: 3, name: 'Campana — reanudar tras Break 3 (Día 1)', type: 'campana', description: 'Toque de campana al terminar el Break 3 para llamar a los caminantes a la siguiente charla.', responsabilityName: R.campanero },
	...
	{ defaultDay: 2, defaultOrder: 33, defaultStartTime: '09:27', defaultDurationMinutes: 3, name: 'Campana — reanudar tras Break 1 (Día 2)', type: 'campana', description: 'Toque de campana al terminar el Break 1 para llamar a los caminantes al resumen del día.', responsabilityName: R.campanero },
	...
	{ defaultDay: 2, defaultOrder: 70, defaultStartTime: '12:02', defaultDurationMinutes: 3, name: 'Campana — reanudar tras Break 2 (Día 2)', type: 'campana', description: 'Toque de campana al terminar el Break 2 para llamar a los caminantes a la charla de Sacramentos.', responsabilityName: R.campanero },
	{ defaultDay: 2, defaultOrder: 75, defaultStartTime: '12:05', defaultDurationMinutes: 45, name: 'Charla: Amando a Dios a través de los Sacramentos', type: 'charla', requiresResponsable: true, locationHint: 'Casa de Retiro', palanquitaNotes: 'Sacerdote Para Siempre', description: 'El sacerdote habla sobre los sacramentos como medios privilegiados para amar a Dios. NO HAY PREGUNTAS.', responsabilityName: R.sacramentos },
	...
	{ defaultDay: 2, defaultOrder: 83, defaultStartTime: '12:57', defaultDurationMinutes: 3, name: 'Campana — reanudar tras Break 3 (Día 2)', type: 'campana', description: 'Toque de campana al terminar el Break 3 para llamar a los caminantes a la charla de la Oración.', responsabilityName: R.campanero },
	...
	{ defaultDay: 2, defaultOrder: 113, defaultStartTime: '15:52', defaultDurationMinutes: 3, name: 'Campana — reanudar tras Break 4 (Día 2)', type: 'campana', description: 'Toque de campana al terminar el Break 4 para llamar a los caminantes a la práctica de la canción.', responsabilityName: R.campanero },
	...
	{ defaultDay: 2, defaultOrder: 138, defaultStartTime: '17:17', defaultDurationMinutes: 3, name: 'Campana — reanudar tras Break 5 (Día 2)', type: 'campana', description: 'Toque de campana al terminar el Break 5 para llamar a los caminantes a la cuarta lectura del Camino de Emaús.', responsabilityName: R.campanero },
	...
	{ defaultDay: 2, defaultOrder: 180, defaultStartTime: '20:40', defaultDurationMinutes: 20, name: 'Recepción de sacerdotes (snack y oración)', type: 'logistica', locationHint: 'Casa de Retiro', description: 'Equipo de Snacks y Oración recibe a los sacerdotes; explicación del retiro y preparación para confesiones. Es la hora a la que se les cita, y la que aparece en la carta al párroco: las confesiones arrancan a las 21:00, cuando los caminantes terminan La Pared.', responsabilityName: R.sacerdotes },
	...
	{ defaultDay: 2, defaultOrder: 200, defaultStartTime: '21:00', defaultDurationMinutes: 60, name: 'Confesiones', type: 'oracion', locationHint: 'Casa de Retiro', description: 'El hijo pródigo pide y recibe el perdón. Sacerdotes confiesan a los caminantes.', responsabilityName: R.sacerdotes },
	...
	{ defaultDay: 3, defaultOrder: 33, defaultStartTime: '10:57', defaultDurationMinutes: 3, name: 'Campana — reanudar tras Break 1 (Día 3)', type: 'campana', description: 'Toque de campana al terminar el Break 1 para llamar a los caminantes al resumen del día.', responsabilityName: R.campanero },
	...
	{ defaultDay: 3, defaultOrder: 63, defaultStartTime: '12:37', defaultDurationMinutes: 3, name: 'Campana — reanudar tras Break 2 (Día 3)', type: 'campana', description: 'Toque de campana al terminar el Break 2 para llamar a los caminantes a la charla de Servicio.', responsabilityName: R.campanero },
	...
	{ defaultDay: 3, defaultOrder: 83, defaultStartTime: '13:37', defaultDurationMinutes: 3, name: 'Campana — reanudar tras Break 3 (Día 3)', type: 'campana', description: 'Toque de campana al terminar el Break 3 para llamar a los caminantes a la dinámica Carta de Jesús.', responsabilityName: R.campanero },
	...
	{ defaultDay: 3, defaultOrder: 123, defaultStartTime: '16:22', defaultDurationMinutes: 3, name: 'Campana — reanudar tras Break 4 (Día 3)', type: 'campana', description: 'Toque de campana al terminar el Break 4 para llamar a los caminantes a la reunión de cierre.', responsabilityName: R.campanero },
